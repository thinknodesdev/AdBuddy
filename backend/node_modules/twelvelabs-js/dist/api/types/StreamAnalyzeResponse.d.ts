 ...
 */
export type StreamAnalyzeResponse = TwelvelabsApi.StreamAnalyzeResponse.StreamStart | TwelvelabsApi.StreamAnalyzeResponse.TextGeneration | TwelvelabsApi.StreamAnalyzeResponse.StreamEnd;
export declare namespace StreamAnalyzeResponse {
    interface StreamStart extends TwelvelabsApi.StreamStartResponse {
        eventType: "stream_start";
    }
    interface TextGeneration extends TwelvelabsApi.StreamTextResponse {
        eventType: "text_generation";
    }
    interface StreamEnd extends TwelvelabsApi.StreamEndResponse {
