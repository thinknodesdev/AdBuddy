...
import { BASE_URL, DEFAULT_API_VERSION } from "./constants.mjs";
export class TwelveLabs extends APIClient {
    constructor({ apiKey, version = DEFAULT_API_VERSION }) {
        if (!apiKey) {
...
export { Engine, Index, IndexListWithPagination, Video, VideoListWithPagination, Task, TaskListWithPagination, SearchResult, EmbeddingsTask, EmbeddingsTaskStatus, CreateEmbeddingsResult, } from "./models/index.mjs";
